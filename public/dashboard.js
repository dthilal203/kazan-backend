let data = null;
let ui = { redirected:false, visListener:null };
    ...
    <div class="wrap">
      <header>
        ...
        <div class="header-actions">
          ...
          <button class="avatar" id="avatarBtn">${data.accounts[0].address[0].toUpperCase()}</button>
        </div>
      </header>
...
function toggleAccountMenu(){
  ...
  const dd = document.createElement('div');
  dd.className = 'dropdown';
  dd.innerHTML = `<div class="account-menu">
